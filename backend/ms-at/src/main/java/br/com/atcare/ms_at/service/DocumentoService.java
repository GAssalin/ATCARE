...
import br.com.atcare.ms_at.mapper.DocumentoMapper;
...
public class DocumentoService {
    ...
    public DocumentoResponseDTO criar(Long atId, DocumentoRequestDTO dto) {
    ...
    public DocumentoResponseDTO atualizar(Long id, DocumentoRequestDTO dto) {
        Documento existente = buscarEntidadePorId(id);
        Documento dados = mapper.toEntity(dto, existente.getAt());
        existente.setNome(dados.getNome());
        existente.setTipo(dados.getTipo());
        existente.setArquivoComprovante(dados.getArquivoComprovante());
    ...
    public Documento buscarEntidadePorId(Long id) {
        return repository.findById(id).orElseThrow(() -> new EntityNotFoundException("Documento não encontrado. Id: " + id));
    }
    ...
    private void alterarAtivo(Long id, boolean ativo) {
        Documento entity = buscarEntidadePorId(id);
